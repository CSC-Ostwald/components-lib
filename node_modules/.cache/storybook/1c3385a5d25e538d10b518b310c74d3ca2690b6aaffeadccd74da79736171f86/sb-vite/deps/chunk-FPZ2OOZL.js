...
import {
  ...
  yg,
  zo
} from "./chunk-AWMCPGDR.js";
import {
  gt,
  yn
} from "./chunk-OKVSIDAU.js";
import {
  $u,
  Et,
  Fr,
...
`, { inline: t2 }));
    ...
    if (n3.length > 1 || i2.forceWrapper) l2 = n3;
      ...
      if (n3.length === 1) return l2 = n3[0], typeof l2 == "string" ? d2("span", { key: "outer" }, l2) : l2;
      l2 = null;
    }
...
`).replace(C, "").replace(G, "    ");
  ...
  }(V22), le2 = (ae2 = /* @__PURE__ */ function(e2, t2) {
...
var BooleanControl = ({ name: name2, value: value3, onChange, onBlur, onFocus, argType }) => {
  ...
  if (value3 === void 0) return import_react.default.createElement(zo, { variant: "outline", size: "medium", id: getControlSetterButtonId(name2), onClick: onSetFalse, disabled: readonly }, "Set boolean");
...
var ObjectControl = ({ name: name2, value: value3, onChange, argType }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]), !hasData) return import_react.default.createElement(zo, { disabled: readonly, id: getControlSetterButtonId(name2), onClick: onForceVisible }, "Set object");
...
var TextControl = ({ name: name2, value: value3, onChange, onFocus, onBlur, maxLength, argType }) => {
  ...
  if (value3 === void 0) return import_react.default.createElement(zo, { variant: "outline", size: "medium", disabled: readonly, id: getControlSetterButtonId(name2), onClick: onForceVisible }, "Set string");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-XUSBM63G.js"));
...
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g))) return import_react.default.createElement(vu, null, children);
...
var BananaSlug = class {
  ...
  slug(value3, maintainCase) {
    ...
    for (; own.call(self2.occurrences, result2); ) self2.occurrences[originalSlug]++, result2 = originalSlug + "-" + self2.occurrences[originalSlug];
...
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string") return import_react.default.createElement(xu, null, children);
  let tagID = slugs.slug(children.toLowerCase());
...
//# sourceMappingURL=chunk-FPZ2OOZL.js.map
